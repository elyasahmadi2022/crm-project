...
export const contractService = {
  async getAll(
    filters: ListContractsQueryDto,
    page = 1,
    limit = 10,
  ): Promise<{ contracts: ContractResponseDto[]; pagination: { page: number; limit: number; total: number; totalPages: number } }> {
  ...
  async create(dto: CreateContractDto, createdById: number): Promise<ContractResponseDto> {
