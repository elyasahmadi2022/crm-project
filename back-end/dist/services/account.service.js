...
export class AccountService {
    ...
    async deleteAccount(id) {
        ...
        if (count > 0) {
            throw new Error("Cannot delete account with transactions. Consider deactivating instead.");
        }
    ...
    async getTransactions(accountId, limit = 100) {
