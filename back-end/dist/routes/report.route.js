...
router.get("/employee/:employeeId/weekly/:year/:weekNumber", authenticate, (req, res) => controller.getWeeklySummary(req, res));
router.get("/employee/:employeeId/monthly/:year/:month", authenticate, (req, res) => controller.getMonthlySummary(req, res));
// Summaries — all employees (admin)
router.get("/summary/weekly/:year/:weekNumber", authenticate, (req, res) => controller.getAllEmployeesWeeklySummary(req, res));
router.get("/summary/monthly/:year/:month", authenticate, (req, res) => controller.getAllEmployeesMonthlySummary(req, res));
